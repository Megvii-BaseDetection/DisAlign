...
EXP_NAME="fcn_s101-d8_512x512_160k_ade20k"
CONFIG_FILE=${MMSEG_HOME}/configs/resnest/${EXP_NAME}.py
OUT_FOLDER=$WORKSPACE_PATH/$EXP_NAME/
CKPT_PATH=/data/mmseg_ckpts/model_zoo/fcn/ade20k/fcn_s101-d8_512x512_160k_ade20k_20200807_145416-d3160329.pth
