from cvpods.configs.config_helper import find_key
import torch
...
class GRWFastRCNNOutputs(FastRCNNOutputs):
    ...
    def _init_weights(self, exp_scale=0.7):
        ...
        file_name = os.path.join(folder_name, "datasets/lvis/num_shots_v1.0.json")
        num_samples_list = json.load(open(file_name, 'r'))[1::2]
